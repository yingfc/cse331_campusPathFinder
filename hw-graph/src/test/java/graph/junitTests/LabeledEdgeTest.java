...
public class LabeledEdgeTest {
    ...
    private DirectedGraph.LabeledEdge edge1, edge2, edge3;

    @Before
    public void setUp() throws Exception {
        edge1 = new DirectedGraph.LabeledEdge("", "");
        edge2 = new DirectedGraph.LabeledEdge("a", "aa");
        edge3 = new DirectedGraph.LabeledEdge("b", "ab");
    }

    // tests for constructor
    @Test(expected = IllegalArgumentException.class)
    public void testConstructEdgeWithNullDest() {
        new DirectedGraph.LabeledEdge(null, "aa");
    }

    @Test(expected = IllegalArgumentException.class)
    public void testConstructEdgeWithNullEdgeLabel() {
        new DirectedGraph.LabeledEdge("a", null);
    }
    ...
    public void testEqualsSymmetric() {
        edge2 = new DirectedGraph.LabeledEdge("", "");
    ...
    public void testEqualsTransitive() {
        edge2 = new DirectedGraph.LabeledEdge("", "");
        edge3 = new DirectedGraph.LabeledEdge("", "");
        assertTrue(edge1.equals(edge2));
    ...
    public void testEqualsDifferentEdge() {
        assertTrue(edge3.equals(new DirectedGraph.LabeledEdge("bb", "bb")));
    }

    @Test
    public void testEqualsSameEdge() {
        assertTrue(edge3.equals(new DirectedGraph.LabeledEdge("b", "ab")));
    }
    ...
    public void testHashCodeOfSameEdge() {
        assertEquals(new DirectedGraph.LabeledEdge("b", "ab").hashCode(), edge3.hashCode());
    }

    // test compareTo()
    @Test
    public void testCompareToSameEdge() {
        assertTrue(edge3.compareTo(new DirectedGraph.LabeledEdge("b", "ab")) == 0);
    }

    @Test
    public void testCompareToSmallerDest() {
        assertTrue(edge3.compareTo(new DirectedGraph.LabeledEdge("a", "ab")) > 0);
    }

    @Test
    public void testCompareToBiggerDest() {
        assertTrue(edge3.compareTo(new DirectedGraph.LabeledEdge("d", "ab")) < 0);
    }

    @Test
    public void testCompareToSmallerEdgeLabel() {
        assertTrue(edge3.compareTo(new DirectedGraph.LabeledEdge("a", "aa")) > 0);
    }

    @Test
    public void testCompareToBiggerEdgeLabel() {
        assertTrue(edge3.compareTo(new DirectedGraph.LabeledEdge("a", "cc")) < 0);
    }
}
